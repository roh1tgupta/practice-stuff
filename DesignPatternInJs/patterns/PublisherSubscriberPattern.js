...
// This design pattern is useful in situations when we need to perform multiple
// operations on a single event being fired. Imagine you have a scenario where
// we need to make multiple AJAX calls to a back-end service and then perform other
// AJAX calls depending on the result. You would have to nest the AJAX calls one within
// the other, possibly entering into a situation known as callback hell. Using the
